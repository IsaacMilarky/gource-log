...
gource-log uses [Semantic Versioning](https://semver.org/). Each release is associated with a [`git tag`](github.com/IsaacMilarky/gource-log/tags) of the form `X.Y.Z`.
...
The following steps describe how to make an approved [Release Candidate](#preparing-a-release-candidate) an official release of gource-log:
...
[proj-releases-new]: https://github.com/IsaacMilarky/gource-log/releases/new
